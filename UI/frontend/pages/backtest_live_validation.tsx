      ...
      {runData && (
        <>
          ...
          <LineChart
            ...
            series={[
              { name: 'Backtest cumulative PNL', color: '#2563eb', data: normalizeSeriesToZero(runData?.pnl_chart?.backtest || []) },
              { name: 'Live cumulative PNL', color: '#16a34a', data: normalizeSeriesToZero(runData?.pnl_chart?.live || []) },
            ]}
          />
