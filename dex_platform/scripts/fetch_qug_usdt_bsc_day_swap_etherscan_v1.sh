...
SCRIPT_VERSION="fetch_qug_usdt_bsc_day_swap_etherscan_v1_2026_05_02_full_file"
...
OUT_DIR="${1:-DEX_DATA/uniswap_v3_bsc/QUG_USDT_001_2026_05_01_day_swap_etherscan_v1}"
