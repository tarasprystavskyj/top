...
#   bash dex_platform/scripts/fetch_check_2pct_aerodrome_recent_events_v2.sh

POOL="0x5a7b4970b2610aee4776a6944d9f2171ee6060b0"
OUT_DIR="${1:-DEX_DATA/aerodrome_slipstream/base_CHECK_USDC_2PCT_recent_2026_05_01_v2}"
