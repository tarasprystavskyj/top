...
def main():
    ...
    # legacy scoring flags (accepted for compatibility, currently unused)
    ap.add_argument("--w-equity", type=float, default=1.0, help="legacy scoring weight (unused)")
    ap.add_argument("--w-pf", type=float, default=10.0, help="legacy scoring weight (unused)")
    ap.add_argument("--w-dd", type=float, default=200.0, help="legacy scoring weight (unused)")
    ap.add_argument("--w-mono", type=float, default=5.0, help="legacy scoring weight (unused)")
    ap.add_argument("--dd-target", type=float, default=0.12, help="legacy scoring parameter (unused)")
    ap.add_argument("--target-trades", type=int, default=300, help="legacy scoring parameter (unused)")
