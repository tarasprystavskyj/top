...
CFG="${CFG:-${REPO_ROOT}/obw_platform/meta_strategies/telegram_signal_dca/configs/mexc_veronika_hype_live_49p5.json}"
OUT_DIR="${OUT_DIR:-/var/www/vps2.happyuser.info/top/top_1/obw_platform/_reports/_live/veronika_hype_mexc_49p5_$(date -u +%Y%m%dT%H%M%SZ)}"
RUN_ID="${RUN_ID:-VERONIKA_HYPE_MEXC_49P5_$(date -u +%Y%m%dT%H%M%SZ)}"
