...
class HypeCap100BingXLiveCanaryTest(unittest.TestCase):
    ...
    def test_parser_normalize_validate_and_reports_root_behavior(self):
        ...
        self.assertEqual(Path(args.out_dir).parent, live.LIVE_REPORTS_ROOT)
        self.assertEqual(tuple(Path(args.out_dir).parts[-4:]), ("obw_platform", "_reports", "_live", "hype_canary_bingx_live"))
