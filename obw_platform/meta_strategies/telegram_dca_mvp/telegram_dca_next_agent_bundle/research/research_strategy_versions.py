...
NPZ=Path('/mnt/data/local_test_tar_bundle/DB/telegram_signals_1m_event_windows_bingx.npz')
SIG=Path('/mnt/data/all_followup/telegram_signals_extracted.csv')
MFE=Path('/mnt/data/all_followup/all_signals_mfe_vs_tp1_rows.csv')
OUT=Path('/mnt/data/strategy_versions_research')
