...
class VirtualExchange:
    ...
    def fetch_ticker(self, symbol: str) -> Dict[str, Any]:
        ...
        return {'symbol': bar['symbol'], 'timestamp': bar['timestamp'], 'datetime': _iso_from_ms(bar['timestamp']), 'last': bar['close'], 'close': bar['close'], 'bid': bar['close'], 'ask': bar['close'], 'info': {'markPrice': bar['close']}}
